const styles = {
    ...
    h1Text:
      "font-bold font-IBMPlex text-5xl sm:text-4xl minmd:text-5xl minlg:text-8xl leading-13 minmd:leading-13",
    pText:
      "my-5 minmd:my-10 font-IBMPlex font-light text-xl minmd:text-3xl minlg:text-4xl minmd:leading-16",
    descriptionText:
      "my-5 minmd:my-10 font-IBMPlex font-light text-xl minmd:text-1xl minlg:text-4xl minmd:leading-16",
    ...
    descDiv: "flex-1 w-full justify-start flex-col md:mb-10 ",
  
    flexCenter: "flex justify-center items-center",
    flexWrap: "flex justify-center flex-wrap",
  
    fullImg: "w-full h-full object-cover mr-12",
    sectionImg: "w-full h-full minmd:w-12/12 minmd:h-12/12 object-contain",
    ...
    featureCard:
      "bg-white m-5 p-6 rounded-md flex justify-around items-center flex-col hover:shadow-lg w-40 h-40 minlg:w-80 minlg:h-80",
  };
